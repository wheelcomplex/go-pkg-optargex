...
const versionName = "__ver"

// Returns version information in a formatted string.
func VersionString() string {
	var output []string

	for _, v := range options {
		if v.ShortName != versionName {
			continue
		}
		output = append(output, fmt.Sprintf(VersionFmt, v.Description))
	}
...
// Adds a version infomation text.
